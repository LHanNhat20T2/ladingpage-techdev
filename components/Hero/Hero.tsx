...
const Hero = () => {
    return (
        <div className="relative w-full h-[110vh] sm:h-screen bg-[url('/images/bg.png')] bg-cover bg-center flex justify-center items-center flex-col">
            <div className="w-[90%] md:w-[80%] mx-auto items-center grid grid-cols-1 xl:grid-cols-2 gap-10">
                {/* Text Content */}
                <div data-aos="fade-up">
                    <p className="text-sm ms:text-base md:text-xl font-bold text-blue-950">
                    ...
                    <p className="text-xs sm:text-sm md:text-base font-medium text-gray-700">
                        ...
                        elit. Velit quam rerum laudantium, hic adipisci commodi
                        minus beatae voluptas earum. Mollitia! Lorem ipsum dolor
                        sit amet consectetur adipisicing elit. Iure, facere
                        eveniet non autem reprehenderit commodi dolore animi
                        voluptate asperiores excepturi.
                    </p>
                    {/* Rating */}
